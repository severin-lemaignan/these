...
implies that the robot is able not only to represent inanimate objects, not
only represent its own mind mind,  but also other intelligences, other minds.
And not only represent them, but also interact with them, which require
communication skills, ability to take perspectives and a theory of mind.
...
A first challenge is to understand what are the cognitive prerequisites for
