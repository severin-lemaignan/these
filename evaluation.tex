...
\section{Summary of contributions to the Knowledge Representation question}
...
\multirow{4}{*}{\turn{90}{\bf Expressiveness}}                   & Logical formalism & TFS                       & (none)                      & (none)                      & ASP                         & Prolog                             &                                 & DL + Horn clauses             & {\sc CycL}                    & DL (OWL)                                      \\
                                                                           & OWA/CWA &                           &                             &                             & CWA                         & CWA                                &                                 &                               &                               & OWA                                           \\
...
the ability to \emph{"operate successfully in the common sense informatic
situation"},
...
\subsection{Knowledge Representation based on Logic Formalisms}

the necessity of relying on mathematical logic, as the most fruitful formalism
for machine intelligence,

\subsection{Management of uncertainty and approximation}

the ability to deal with \emph{approximate concepts and approximate theories}
(that would include representing them, and reasoning with them),
...
+ what McCarthy calls \emph{Elaboration Tolerance}: the ability to extend
\emph{on demand} the closed domain of interpretation for a given assertion,

\subsection{Modeling of contexts}

the ability to formalize and reason about contexts,

Roy + McCarthy

The ORO knowledge base offers some support for the \emph{modeling of context},
but a lot remains to be done in this respect.

While several approaches for building contextualized knowledge are proposed in
this paper (symbolic environment interpretation, perspective taking, grounded
