...
The table below summarises the terminology that we use in this work to discuss
...
Description Logic. In other cases, we use the term \emph{concept} as a general
